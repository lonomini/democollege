        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className='inputField'>
                ...
                <div className='inputDiv'>
                    <input className={message.emailEmpty[0] ? "emptyInput" : ""} type='text' name='useremail' id='useremail' onChange={ (e)=> setEmail(e.target.value)} value={email}></input>
            ...
            <div className='inputField'>
                ...
                <div className='inputDiv'>
                    <input className={message.passwordEmpty[0] ? "emptyInput" : ""} type='password' name='password' id='password' onChange={ (e)=> setPassword(e.target.value)} value={password}></input>
